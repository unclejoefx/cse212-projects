public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Dequeue uses index [1] instead of [0] - causes IndexOutOfRangeException
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue uses Insert(0) adding to front instead of back - violates FIFO 
